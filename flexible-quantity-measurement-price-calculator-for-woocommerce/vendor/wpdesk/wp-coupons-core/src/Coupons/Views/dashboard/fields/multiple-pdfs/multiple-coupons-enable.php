...
woocommerce_wp_checkbox(
	[
		'id'                => "fc_multiple_pdf_enable{$loop_id}",
		'name'              => "fc_multiple_pdf_enable{$loop_name}",
		'value'             => $value,
		'label'             => esc_html__( 'Split coupons by product quantity', 'wp-coupons-core' ),
		'desc_tip'          => true,
		'description'       => esc_html__( 'Enable this option to split coupons as different products in cart.', 'wp-coupons-core' ),
		'wrapper_class'     => 'multiple-pdf-settings',
		'class'             => 'fc_multiple_pdf_enable',
