...
class Settings
{
    ...
    */
    ...
    {
        $settings = $this->get_settings();
        $sold_individually = isset($settings['fq']['sold_individually']) && $settings['fq']['sold_individually'] == 'yes';
    ...
    protected function get_settings_pricing_rules()
    {
        $settings = $this->get_settings();
        $pricing_rules = [];
    ...
    /**
     * Returns the calculator basic increment, if this is a calculator
     *
     * @return string basic increment
     */
    public function get_basic_increment()
    {
        if ($this->is_calculator_enabled()) {
            $settings = $this->get_settings();
            $unit = $settings['fq']['increment'];
            return $unit;
        }
        return '';
    }
