...
\woocommerce_wp_checkbox(['id' => "fc_multiple_pdf_enable{$loop_id}", 'name' => "fc_multiple_pdf_enable{$loop_name}", 'value' => $value, 'label' => \esc_html__('Split coupons by product quantity', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'description' => \esc_html__('Enable this option to split coupons as different products in cart.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'wrapper_class' => 'multiple-pdf-settings', 'class' => 'fc_multiple_pdf_enable', 'custom_attributes' => $custom_attributes]);
