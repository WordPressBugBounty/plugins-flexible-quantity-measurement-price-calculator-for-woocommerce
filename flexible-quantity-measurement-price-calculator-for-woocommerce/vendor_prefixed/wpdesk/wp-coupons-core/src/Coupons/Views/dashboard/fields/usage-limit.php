...
\woocommerce_wp_checkbox(['id' => 'fc_remove_usage_limit' . $loop_id, 'name' => 'fc_remove_usage_limit' . $loop_name, 'value' => $value, 'label' => \esc_html__('Allow to multiuse', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'description' => \esc_html__('Check this option if you want to allow customer to spread the coupon value over several purchases. For example, a coupon worth $100 for two purchases of $50.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'wrapper_class' => !$is_premium ? 'read-only' : '', 'custom_attributes' => $custom_attributes]);
