...
\woocommerce_wp_select(['id' => 'fc_product_template' . $loop_id, 'name' => 'fc_product_template' . $loop_name, 'value' => $value, 'label' => \esc_html__('Coupon template', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'options' => $product_templates, 'description' => \esc_html__('Select coupon template for this product', 'flexible-quantity-measurement-price-calculator-for-woocommerce')]);
