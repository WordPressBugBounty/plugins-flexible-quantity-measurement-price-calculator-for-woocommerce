...
final class WooCommerceShippingInstanceContainer implements PersistentContainer {
	...
	public function set( string $id, $value ) {
		...
		update_option( $this->method->get_instance_option_key(),
			apply_filters( 'woocommerce_shipping_' . $this->method->id . '_instance_settings_values',
				$this->method->instance_settings, $this->method ), 'yes' );
	}
