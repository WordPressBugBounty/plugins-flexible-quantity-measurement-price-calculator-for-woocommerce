...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?>"
				},
				library: {
					type: ['image']
