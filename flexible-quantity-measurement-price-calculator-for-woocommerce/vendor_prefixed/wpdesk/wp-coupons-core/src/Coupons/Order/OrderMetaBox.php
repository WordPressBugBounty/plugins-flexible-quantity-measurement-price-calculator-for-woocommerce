 ...
 */
namespace WDFQVendorFree\WPDesk\Library\WPCoupons\Order;
        ...
        if ($this->is_order_page()) {
            ...
            if ($order instanceof \WC_Order) {
                ...
                foreach ($products as $key => $items) {
                    ...
                    if ($is_coupon_item) {
                        \add_meta_box('flexible_coupon__' . $key, \__('PDF Coupon', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), [$this, 'order_coupon_callback'], $screens, self::META_BOX_CONTEXT_SIDE, self::META_BOX_PRIORITY_LOW, ['post_id' => $order_id, 'items' => $items]);
                    }
                    // }
                }
            }
