...
\esc_attr_e('Search for a product&hellip;', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?>"
...
?>
	...
	<?php 
echo \wc_help_tip(\esc_html__('Products for which the coupon will be used. Do not select any to apply to all products.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'));
?>
</p>
<?php 
