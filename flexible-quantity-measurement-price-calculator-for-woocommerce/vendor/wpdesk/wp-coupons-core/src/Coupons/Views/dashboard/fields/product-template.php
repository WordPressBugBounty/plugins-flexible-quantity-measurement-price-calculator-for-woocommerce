...
woocommerce_wp_select(
	[
		'id'          => 'fc_product_template' . $loop_id,
		'name'        => 'fc_product_template' . $loop_name,
		'value'       => $value,
		'label'       => esc_html__( 'Coupon template', 'wp-coupons-core' ),
		'desc_tip'    => true,
		'options'     => $product_templates,
		'description' => esc_html__( 'Select coupon template for this product', 'wp-coupons-core' ),
	]
);
