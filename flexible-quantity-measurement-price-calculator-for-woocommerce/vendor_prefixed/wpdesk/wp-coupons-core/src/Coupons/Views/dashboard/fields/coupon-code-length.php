...
\woocommerce_wp_text_input(['id' => 'fc_coupon_code_length' . $loop_id, 'name' => 'fc_coupon_code_length' . $loop_name, 'value' => $value, 'label' => \esc_html__('Number of random characters', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'type' => 'number', 'desc_tip' => \true, 'description' => \esc_html__('The number of random characters in the coupon code. Random characters will be used for generating unique coupon codes. Choose the number between 5 and 30.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'wrapper_class' => !$is_premium ? 'read-only coupon-code-settings' : ' coupon-code-settings', 'custom_attributes' => $custom_attributes]);
