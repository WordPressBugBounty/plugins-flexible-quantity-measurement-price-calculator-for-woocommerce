...
use WDFQVendorFree\Mpdf\Mpdf;
use WDFQVendorFree\Mpdf\Output\Destination;
use WDFQVendorFree\WPDesk\Library\CouponInterfaces\EditorAreaProperties;
use WDFQVendorFree\Mpdf\Config\FontVariables;
/**
 * PDF library wrapper.
 *
