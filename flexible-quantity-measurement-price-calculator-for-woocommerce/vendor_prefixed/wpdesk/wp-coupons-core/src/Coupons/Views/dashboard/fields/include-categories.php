...
?>"><?php 
\esc_html_e('Product categories', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?></label>
	<select
...
\esc_attr_e('Any category', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?>">
		<?php 
...
echo \wc_help_tip(\esc_html__('Categories for which the coupon will be used. Do not select any to apply to all categories.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'));
?>
</p>
<?php 
