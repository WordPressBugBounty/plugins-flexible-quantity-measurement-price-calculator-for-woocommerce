...
woocommerce_wp_checkbox(
	[
		'id'                => "fc_multiple_pdf_first_mail{$loop_id}",
		'name'              => "fc_multiple_pdf_first_mail{$loop_name}",
		'value'             => $value,
		'label'             => esc_html__( 'Send coupons to first recipient', 'wp-coupons-core' ),
		'desc_tip'          => true,
		'description'       => esc_html__( 'Enable this option to send all bought coupons to email of first recipient. This option disables email field for other recipients.', 'wp-coupons-core' ),
		'wrapper_class'     => 'multiple-pdf-settings fc_multiple_pdf_advanced',
		'class'             => 'fc_multiple_pdf_first_mail',
