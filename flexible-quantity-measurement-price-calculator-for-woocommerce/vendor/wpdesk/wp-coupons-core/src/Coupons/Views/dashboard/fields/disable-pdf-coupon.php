...
woocommerce_wp_checkbox(
	[
		'id'                => "fc_disable_pdf{$loop_id}",
		'name'              => "fc_disable_pdf{$loop_name}",
		'value'             => $value,
		'label'             => esc_html__( 'Disable the PDF coupon for this variation', 'wp-coupons-core' ),
		'desc_tip'          => true,
		'description'       => '',
		'wrapper_class'     => '',
		'class'             => 'fc_disable_pdf_coupon',
