...
\woocommerce_wp_text_input(['id' => "fc_multiple_pdf_forms_limit{$loop_id}", 'name' => "fc_multiple_pdf_forms_limit{$loop_name}", 'value' => $value, 'type' => 'number', 'label' => \esc_html__('Limit recipient forms per product', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'description' => \esc_html__('Enter the maximum number of recipient forms on the product page.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'wrapper_class' => 'multiple-pdf-settings fc_multiple_pdf_advanced', 'class' => 'fc_multiple_pdf_forms_limit fullwidth_field', 'custom_attributes' => $custom_attributes]);
