...
class Inflectible
{
    ...
    {
        yield new Transformation(new Pattern('/ú([sn])$/i'), 'WDFQVendorFree\u\1es');
        yield new Transformation(new Pattern('/ó([sn])$/i'), 'WDFQVendorFree\o\1es');
        yield new Transformation(new Pattern('/í([sn])$/i'), 'WDFQVendorFree\i\1es');
        yield new Transformation(new Pattern('/é([sn])$/i'), 'WDFQVendorFree\e\1es');
        yield new Transformation(new Pattern('/á([sn])$/i'), 'WDFQVendorFree\a\1es');
