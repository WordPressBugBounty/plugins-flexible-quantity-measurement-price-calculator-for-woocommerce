...
class Cart implements \WDFQVendorFree\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function add_to_cart_validation($valid, $product_id, $quantity, $variation_id = '', $variations = [], $cart_item_data = [])
    {
        ...
        if ($valid && \WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Product::pricing_calculator_enabled($product, $settings)) {
    ...
    public function get_cart_item_data($cart_item_data, $product_id, $variation_id) : array
    {
        ...
        if (\WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Product::pricing_calculator_enabled($product, $settings)) {
            ...
            if ($measurement_needed_value !== null) {
                ...
                $price = \WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Product::calculate_price($_product, $measurement_needed_value, $measurement_needed_value_unit, \false, $settings);
    ...
    public function setup_measurement_overage_data($cart_item_data, $measurement_needed_value, $measurement_needed_value_unit, $_product, $settings = null, $order_again = \false)
    {
        ...
        $settings = null === $settings ? new \WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Settings($_product) : $settings;
        ...
        if ($pricing_overage_percentage > 0) {
            ...
            $cart_item_data['pricing_item_meta_data']['_price_overage'] = \WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Product::calculate_price($_product, $measurement_needed_value_overage, $measurement_needed_value_unit, $settings);
