...
\woocommerce_wp_text_input(['id' => 'fc_sending_delay_fixed_date' . $loop_id, 'name' => 'fc_sending_delay_fixed_date' . $loop_name, 'type' => 'datetime-local', 'value' => $value, 'label' => \esc_html__('Date', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'wrapper_class' => !$is_sending ? 'read-only coupon-code-settings' : 'coupon-code-settings', 'class' => 'show_if_fixed_date_delay short fc_variation_base_on', 'custom_attributes' => $custom_attributes]);
