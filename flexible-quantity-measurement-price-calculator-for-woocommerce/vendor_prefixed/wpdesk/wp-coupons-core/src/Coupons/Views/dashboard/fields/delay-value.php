...
\woocommerce_wp_select(['id' => 'fc_sending_delay_value' . $loop_id, 'name' => 'fc_sending_delay_value' . $loop_name, 'value' => $value, 'label' => \esc_html__('Delay', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'options' => \array_combine(\range(1, 12), \range(1, 12)), 'wrapper_class' => !$is_sending ? 'read-only' : '', 'class' => 'show_if_simple_delay short fc_variation_base_on', 'custom_attributes' => $custom_attributes]);
