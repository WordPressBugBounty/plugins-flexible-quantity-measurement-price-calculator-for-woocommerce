...
\woocommerce_wp_checkbox(['id' => "fc_coupon_code{$loop_id}", 'name' => "fc_coupon_code{$loop_name}", 'value' => $value, 'label' => \esc_html__('Define own coupon code', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'desc_tip' => \true, 'description' => \esc_html__('Enable this option to overwrite plugin settings and configure your own coupon code settings for this product.', 'flexible-quantity-measurement-price-calculator-for-woocommerce'), 'wrapper_class' => 'coupon-code-settings', 'class' => 'fc_coupon_own_code', 'custom_attributes' => $custom_attributes]);
