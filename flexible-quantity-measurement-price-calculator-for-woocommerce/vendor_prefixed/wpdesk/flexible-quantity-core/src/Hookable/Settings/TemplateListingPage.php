 ...
 */
class TemplateListingPage implements Hookable
{
    /**
     * @var Renderer
     */
    ...
    {
        add_filter('manage_' . FQTemplateType::POST_TYPE . '_posts_columns', [$this, 'add_column'], 11);
        add_action('manage_' . FQTemplateType::POST_TYPE . '_posts_custom_column', [$this, 'get_value'], 10, 2);
    }
    ...
    {
        return trim(array_reduce(array_filter($collection, 'is_object'), fn($carry, $obj) => $carry . $fn($obj) . self::DELIMITER, ''), self::DELIMITER);
    }
}
