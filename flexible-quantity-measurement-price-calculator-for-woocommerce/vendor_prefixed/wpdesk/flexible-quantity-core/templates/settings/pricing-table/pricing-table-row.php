...
<tr>
	<td>
		<?php 
\woocommerce_wp_text_input(['id' => '', 'name' => 'fq[pricing_table][items][from][]', 'class' => 'fq_pricing_table_from', 'value' => $from, 'wrapper_class' => 'myclass', 'label' => \false, 'placeholder' => '', 'type' => 'number', 'custom_attributes' => ['step' => '1', 'min' => '0']]);
?>
	</td>
	<td>
		<?php 
\woocommerce_wp_text_input(['id' => '', 'name' => 'fq[pricing_table][items][to][]', 'value' => $to, 'class' => 'fq_pricing_table_to', 'label' => \false, 'placeholder' => '', 'type' => 'number', 'custom_attributes' => ['step' => '1', 'min' => '0']]);
?>
	</td>
	<td>
		<?php 
