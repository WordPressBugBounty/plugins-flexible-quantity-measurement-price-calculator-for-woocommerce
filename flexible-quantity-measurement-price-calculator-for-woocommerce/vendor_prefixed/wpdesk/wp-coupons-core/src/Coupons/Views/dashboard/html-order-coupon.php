...
\esc_html_e('Product name:', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
?></strong> <a
			href="<?php 
...
if (!$coupon_id) {
    ...
    ?>"><?php 
    \esc_html_e('Generate coupon', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
    ?></button>
		<?php 
