...
\woocommerce_wp_select(
	[
		'id'                => 'fc_sending_delay_interval' . $loop_id,
		'name'              => 'fc_sending_delay_interval' . $loop_name,
		'value'             => $value,
		'label'             => \esc_html__( 'Interval', 'wp-coupons-core' ),
		'desc_tip'          => true,
		'options'           => [
			'hours'  => __( 'Hours', 'wp-coupons-core' ),
			'days'   => __( 'Days', 'wp-coupons-core' ),
			'weeks'  => __( 'Weeks', 'wp-coupons-core' ),
			'months' => __( 'Months', 'wp-coupons-core' ),
		],
		'wrapper_class'     => ! $is_sending ? 'read-only' : '',
		'class'             => 'show_if_simple_delay short fc_variation_base_on',
