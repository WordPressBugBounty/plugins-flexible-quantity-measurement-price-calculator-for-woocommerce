...
class ProductPage implements \WDFQVendorFree\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function __construct(\WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\Services\SettingsContainer $settings_container, \WDFQVendorFree\WPDesk\View\Renderer\Renderer $renderer)
    {
    ...
    public function render_single_measurement_field(\WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Measurement $measurement, \WDFQVendorFree\WPDesk\Library\FlexibleQuantityCore\WooCommerce\Settings $settings) : void
    {
