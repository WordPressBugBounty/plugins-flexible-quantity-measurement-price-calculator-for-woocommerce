...
namespace WDFQVendorFree\Psr\Log\Test;

use WDFQVendorFree\Psr\Log\LoggerInterface;
use WDFQVendorFree\Psr\Log\LogLevel;
use WDFQVendorFree\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WDFQVendorFree\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WDFQVendorFree\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WDFQVendorFree\Psr\Log\Test\DummyTest', array('__toString'));
        }
