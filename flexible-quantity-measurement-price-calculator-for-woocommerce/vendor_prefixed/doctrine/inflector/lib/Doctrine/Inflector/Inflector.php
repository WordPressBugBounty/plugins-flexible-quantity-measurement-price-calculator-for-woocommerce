...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\WDFQVendorFree\Doctrine\Inflector\WordInflector $singularizer, \WDFQVendorFree\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => 'WDFQVendorFree\\1_\\2', '/([a-z\\d])([A-Z])/' => 'WDFQVendorFree\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
