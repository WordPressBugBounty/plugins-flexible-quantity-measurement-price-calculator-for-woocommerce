...
woocommerce_wp_text_input(
	[
		'id'                => 'fc_expiring_date_own' . $loop_id,
		'name'              => 'fc_expiring_date_own' . $loop_name,
		'value'             => $value,
		'label'             => esc_html__( 'Own expiration time', 'wp-coupons-core' ),
		'desc_tip'          => true,
		'type'              => 'number',
		'description'       => esc_html__( 'Define own time from purchase to expiration of a generated coupon.', 'wp-coupons-core' ),
		'wrapper_class'     => ! $is_premium ? 'read-only expiring-date-own' : 'expiring-date-own',
		'class'             => 'expiring-date-select select short',
		'custom_attributes' => [
			'min' => 1,
		],
	]
