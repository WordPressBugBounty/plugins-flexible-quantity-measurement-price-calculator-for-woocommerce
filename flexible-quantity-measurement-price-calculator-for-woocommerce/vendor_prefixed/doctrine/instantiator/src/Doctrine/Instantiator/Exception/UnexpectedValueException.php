...
namespace WDFQVendorFree\Doctrine\Instantiator\Exception;
 ...
 */
class UnexpectedValueException extends \UnexpectedValueException implements \WDFQVendorFree\Doctrine\Instantiator\Exception\ExceptionInterface
{
    /**
