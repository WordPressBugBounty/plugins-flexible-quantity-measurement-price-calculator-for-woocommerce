...
final class Tracker
{
    ...
    private function register_hooks()
    {
        ...
        add_action('admin_init', [\WDFQVendorFree\WPDesk_Tracker::class, 'schedule']);
    ...
    public function send_scheduled_tracking_data()
    {
        ...
        if ($tracker instanceof \WDFQVendorFree\WPDesk_Tracker) {
    ...
    private function get_tracker()
    {
        ...
        if (!is_object($tracker)) {
            $factory = new \WDFQVendorFree\WPDesk_Tracker_Factory_Prefixed($this->logger);
